...
import type { QualityOfficerLanguage } from "@/components/dashboard/quality-officer/settings/quality-officer-settings.types";
import { cn } from "@/lib/cn";

type QualityOfficerLanguageRegionSectionProps = {
  language: QualityOfficerLanguage;
  onLanguageChange: (language: QualityOfficerLanguage) => void;
};
...
export function QualityOfficerLanguageRegionSection({ language, onLanguageChange }: QualityOfficerLanguageRegionSectionProps) {
  return (
