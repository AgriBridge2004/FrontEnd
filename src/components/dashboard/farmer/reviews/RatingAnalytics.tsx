import { RatingDistribution } from "@/components/dashboard/farmer/reviews/RatingDistribution";
import { performanceAreas } from "@/components/dashboard/farmer/reviews/reviews.mock";
