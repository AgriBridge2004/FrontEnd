...
import { ProductPhotoUpload } from "@/components/dashboard/farmer/create-listing/steps/details/ProductPhotoUpload";
import { qualityGradeOptions, uploadPhotoOptions } from "@/components/dashboard/farmer/create-listing/create-listing.mock";
