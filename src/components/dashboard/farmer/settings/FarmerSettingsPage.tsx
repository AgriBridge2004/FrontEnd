...
import { AccountProfileSettings } from "@/components/dashboard/farmer/settings/AccountProfileSettings";
import { ConnectedDevicesSettings } from "@/components/dashboard/farmer/settings/ConnectedDevicesSettings";
import { ContactInfoSettings } from "@/components/dashboard/farmer/settings/ContactInfoSettings";
import { DangerZoneSettings } from "@/components/dashboard/farmer/settings/DangerZoneSettings";
import { LanguageRegionSettings } from "@/components/dashboard/farmer/settings/LanguageRegionSettings";
import { PaymentPayoutSettings } from "@/components/dashboard/farmer/settings/PaymentPayoutSettings";
import { SecurityLoginSettings } from "@/components/dashboard/farmer/settings/SecurityLoginSettings";
import { SettingsSideNav } from "@/components/dashboard/farmer/settings/SettingsSideNav";
import { SettingsToast } from "@/components/dashboard/farmer/settings/SettingsToast";
import { farmerSettings, type FarmerSettings } from "@/components/dashboard/farmer/settings/settings.mock";
