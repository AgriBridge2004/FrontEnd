...
import { CreditCard, Globe, KeyRound, Monitor, Shield, Trash2, User } from "lucide-react";

import { cn } from "@/lib/cn";

const navItems = [
  { id: "account-profile", label: "Account & Profile", icon: User },
  { id: "contact-info", label: "Contact Info", icon: KeyRound },
...
export function SettingsSideNav({ activeSection, onSectionChange }: SettingsSideNavProps) {
  return (
