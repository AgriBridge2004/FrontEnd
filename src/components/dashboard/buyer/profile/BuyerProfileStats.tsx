...
type BuyerProfileStatsProps = {
  stats: BuyerProfile["stats"];
};

export function BuyerProfileStats({ stats }: BuyerProfileStatsProps) {
  const items = [
    { label: "Completed Purchases", value: stats.completedPurchases, icon: Handshake },
    { label: "On-time Delivery Rate", value: `${stats.onTimeDeliveryRate}%`, icon: CheckCircle },
    { label: "Active Contracts", value: stats.activeContracts, icon: ShoppingBag },
  ];
