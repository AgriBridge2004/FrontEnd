...
type BuyerDangerZoneSectionProps = {
  onDeleteAccount: () => void;
};

export function BuyerDangerZoneSection({ onDeleteAccount }: BuyerDangerZoneSectionProps) {
  return (
    <BuyerSettingsCard danger id="delete-account">
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm font-medium leading-6 text-slate-600">
              Permanently delete your AgriBridge buyer account and all associated data. This action is irreversible.
            </p>
          </div>
        </div>
