...
import { Bell, CreditCard, Info, Languages, Shield, Trash2, User } from "lucide-react";
...
const navItems = [
  ...
  { id: "security-login", label: "Security & Login", icon: Shield },
  { id: "language-region", label: "Language & Region", icon: Languages },
  { id: "payment-methods", label: "Payment Methods", icon: CreditCard },
  { id: "notification-devices", label: "Notifications Devices", icon: Bell },
  { id: "delete-account", label: "Delete Account", icon: Trash2, danger: true },
];

type BuyerSettingsNavProps = {
  activeSection: string;
  onSectionChange: (sectionId: string) => void;
};

export function BuyerSettingsNav({ activeSection, onSectionChange }: BuyerSettingsNavProps) {
  return (
